...
var MY_ID = get_element('#user-info--name').textContent;
var PEER = new Peer(MY_ID);
var PHONE_BOOK = get_element('#phone-book');
var SIDE_CALL_MONITOR = get_element('.p-index__side-call-monitor')[0];
...
USER_LIST.map(function (li) {
  li.addEventListener('click', function () {
    ...
    var other_id = get_element('p', li)[0].textContent;
